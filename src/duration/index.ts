...
declare global {
  interface Number {
    readonly nanoseconds: Duration
    readonly microseconds: Duration
    readonly milliseconds: Duration
    readonly seconds: Duration
    readonly minutes: Duration
    readonly hours: Duration
    readonly days: Duration
  }
}

Object.defineProperty(Number.prototype, 'nanoseconds', {
  get(this: number) {
    return Duration.nanoseconds(this)
  },
  enumerable: false,
  configurable: true,
})

Object.defineProperty(Number.prototype, 'microseconds', {
  get(this: number) {
